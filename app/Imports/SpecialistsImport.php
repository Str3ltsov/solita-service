...
class SpecialistsImport implements ToModel, WithHeadingRow, WithValidation, SkipsEmptyRows
{
    public function model(array $row)
    {
        return new User([
            ...
            'delete_notifications' => $row['delete_notifications'] ?? 0,
            'delete_messages' => $row['delete_messages'] ?? 0,
    ...
    public function rules(): array
    {
        return [
            ...
            'delete_messages' => 'required|boolean',
        ];
    }
}
