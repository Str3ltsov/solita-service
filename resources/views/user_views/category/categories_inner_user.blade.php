...
@section('content')
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3">
                <aside class="sidebar px-4 pt-2 pb-4" style="box-shadow: 1px 1px 10px #dedede;">
                    <h4 class="sidebar-title">{{ __('names.categories')}}</h4>
                    @include('user_views.category.categoryTree')
                </aside>
            </div>
            <div class="col-lg-9">
                <div class="d-flex flex-column flex-lg-row justify-content-lg-between align-items-lg-center mb-4 mt-4 mt-lg-0 gap-3">
                    <div>
...
{{--                        </div>--}}
                    ...
                    <a href="{{ url("/rootcategories") }}" class="category-return-button col-xl-4 col-lg-5 col-md-5 col-12">
